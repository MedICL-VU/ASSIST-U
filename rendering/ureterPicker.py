...
def click_callback(caller, event):
    """
    ...
    # close_window(caller)
    # caller.GetRenderWindow().Finalize()
    # caller.TerminateApp()


def pickureter(modelpath):
    ...
    if save:
        ...
        w2if.Update()
        writer = vtkPNGWriter()
        writer.SetFileName('screenshots/TestScreenshot1.png')
        ...
        renderWindowInteractor.AddObserver('RightButtonPressEvent', click_callback)
        renderWindowInteractor.Start()
