...
def parse_args():
    ...
    parser.add_argument('--savedir', default='output/mdephantom', type=str)
    parser.add_argument('--save', default=True, type=bool)
    parser.add_argument('--planmode', default='bfs', type=str) #bfs currently broken
    parser.add_argument('--modelname', default='15L', type=str)
    parser.add_argument('--modelpath', default='data/cao_04_29_25_model4.stl', type=str)
    ...
    parser.add_argument('--recon_pcd', default='data/mdephantom/15L/points3D.txt', type=str)
    parser.add_argument('--recon_images', default='data/mdephantom/15L/images.txt', type=str)
    parser.add_argument('--phantom_mesh', default='data/mdephantom/models/pt15L.stl', type=str)
